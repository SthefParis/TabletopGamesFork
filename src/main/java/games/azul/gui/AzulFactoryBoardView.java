...
public class AzulFactoryBoardView extends ComponentView implements IScreenHighlight {
    ...
    public AzulFactoryBoardView(GridBoard<AzulFactoryBoard> gridBoard , AzulGameState gs) {
        super(gridBoard, 0,0);
        this.gs = gs;
    ...
    private void drawFactoryBoard(Graphics2D g, GridBoard<AzulFactoryBoard> gridBoard, int x, int y) {
